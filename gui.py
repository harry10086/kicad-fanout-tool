...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"扇出工具", None))
        self.labelReference.setText(QCoreApplication.translate("MainWindow", u"位号:", None))
        self.checkViaInPad.setText(QCoreApplication.translate("MainWindow", u"焊盘内过孔", None))
        self.checkSkipPad.setText(QCoreApplication.translate("MainWindow", u"跳过未使用的焊盘", None))
        self.labelViaType.setText(QCoreApplication.translate("MainWindow", u"过孔类型:", None))
        self.labelStartlayer.setText(QCoreApplication.translate("MainWindow", u"起始层:", None))
        self.labelViaHole.setText(QCoreApplication.translate("MainWindow", u"过孔孔径:", None))
        self.labelTrackWidth.setText(QCoreApplication.translate("MainWindow", u"线宽:", None))
        self.labelViaDiameter.setText(QCoreApplication.translate("MainWindow", u"过孔直径:", None))
        self.labelEndlayer.setText(QCoreApplication.translate("MainWindow", u"终止层:", None))
        self.labelUnit.setText(QCoreApplication.translate("MainWindow", u"单位:", None))
        self.groupImagePreview.setTitle(QCoreApplication.translate("MainWindow", u"预览:", None))
        self.labelPackage.setText(QCoreApplication.translate("MainWindow", u"封装:", None))
        self.labelDirection.setText(QCoreApplication.translate("MainWindow", u"方向:", None))
        self.labelStaggerGap.setText(QCoreApplication.translate("MainWindow", u"错开间距:", None))
        self.labelAlignment.setText(QCoreApplication.translate("MainWindow", u"对齐方式:", None))
        self.labelFanoutLength.setText(QCoreApplication.translate("MainWindow", u"扇出长度:", None))
        self.labelViaPitch.setText(QCoreApplication.translate("MainWindow", u"过孔间距:", None))
        self.buttonClose.setText(QCoreApplication.translate("MainWindow", u"关闭", None))
        self.buttonConnect.setText(QCoreApplication.translate("MainWindow", u"连接至 KiCad", None))
        self.buttonUndo.setText(QCoreApplication.translate("MainWindow", u"撤销", None))
        self.buttonFanout.setText(QCoreApplication.translate("MainWindow", u"扇出", None))
    # retranslateUi
