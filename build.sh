...
PATH_INSTALL_PLUGIN="$HOME/.local/share/kicad/10.0/3rdparty/plugins/"
PATH_INSTALL_RESOURCE="$HOME/.local/share/kicad/10.0/3rdparty/resources/"
PATH_INSTALL_DEV="$HOME/.local/share/kicad/10.0/plugins/"
